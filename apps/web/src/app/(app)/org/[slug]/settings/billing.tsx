          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {priceFormat(billing.projects.price)} (
                  {priceFormat(billing.projects.unit)} each)
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {priceFormat(billing.seats.price)} (
                  {priceFormat(billing.seats.unit)} each)
                </TableCell>
              </TableRow>
            </TableBody>
            <TableFooter>
